...
import { Activity, ShieldAlert, Cpu, CheckCircle2, Video, ArrowUpRight, Zap, Eye, AlertTriangle } from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col md:flex-row">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <main className="flex-1 p-6 md:p-8 space-y-8 overflow-y-auto max-w-7xl mx-auto w-full">
            ...
            <div className="relative rounded-2xl p-6 md:p-8 overflow-hidden bg-gradient-to-r from-slate-900/90 via-sky-950/40 to-slate-900/90 border border-sky-500/20 shadow-2xl">
